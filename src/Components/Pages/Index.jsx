    ...
    <>
      ...
      <div className="product-container py-5 my-5">
        <div className="container position-relative">
          ...
          <div className="product-swiper-prev swiper-button">
          ...
          >
            {Products.filter(
              (product) => product.id >= 5 && product.id <= 12
            ).map((product) => (
          ...
          <div className="product-swiper-next swiper-button">
          ...
          <div className="row">
            <div className="section-title mb-5 product-title text-center">
              <h2 className="fw-semibold fs-1">
                Customer favourite beauty essentials
              </h2>
              <p>
                Made using clean, non-toxic ingredients, our products are
                designed for everyone.
            ...
            <div className="row">
              <div className="col-lg-5">
                <div className="favourite-beauty-banner mb-lg-0 position-relative">
                      ...
                      <div key={product.id}>
                        <div className="product-item mb-5 text-center position-relative">
                          <div className="product-image w-100 position-relative overflow-hidden">
                            ...
                            <span
                              className={`tag badge text-white ${product.tag === "New"
                                  ? "bg-danger"
                                  : "bg-success"
                                }`}
                            >
        ...
        <div className="row g-4">
          <div className="col-lg-2 col-md-4">
            <div className="social-wrapper position-relative overflow-hidden">
              <img src={socialImage1} className="img-fluid" alt="" />
              <i className="bi bi-instagram"></i>
            </div>
          </div>
          <div className="col-lg-2 col-md-4">
            <div className="social-wrapper position-relative overflow-hidden">
              <img src={socialImage2} className="img-fluid" alt="" />
              <i className="bi bi-instagram"></i>
            </div>
          </div>
          <div className="col-lg-2 col-md-4">
            <div className="social-wrapper position-relative overflow-hidden">
              <img src={socialImage3} className="img-fluid" alt="" />
              <i className="bi bi-instagram"></i>
            </div>
          </div>
          <div className="col-lg-2 col-md-4">
            <div className="social-wrapper position-relative overflow-hidden">
              <img src={socialImage4} className="img-fluid" alt="" />
              <i className="bi bi-instagram"></i>
            </div>
          </div>
          <div className="col-lg-2 col-md-4">
            <div className="social-wrapper position-relative overflow-hidden">
              <img src={socialImage5} className="img-fluid" alt="" />
              <i className="bi bi-instagram"></i>
            </div>
          </div>
          <div className="col-lg-2 col-md-4">
