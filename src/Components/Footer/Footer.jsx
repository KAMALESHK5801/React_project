                ...
                <div className="col-lg-8">
                    <div className="row">
                        <div className="col-md-4">
                            ...
                            <p className="mb-0"><strong>+91 0987654321</strong></p>
                            <p>ourshop@gmail.com</p>
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <ul className="list-unstyle">
                                ...
                                <li className="mb-2">
                                    <a href="#" className='text-decoration-none'>- Tearms & Conditions</a>
                                </li>
                                <li className="mb-2">
                    ...
                    <div className="col-lg-4">
                        <div className="footer-logo text-center">
                            <a href="#" className="navbar-brand mx-auto order-0">
                                <h2 className="m-0 fw-bold" style={{letterSpacing:'2px'}}>BEAUTY FACE</h2>
                            </a>
                        </div>
                    </div>
                    <div className="col-lg-4">
